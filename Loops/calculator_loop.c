// Description: A simple calculator that performs basic arithmetic operations (+, -, *, /, ^) in a loop until the user chooses to exit.
// Concepts used: Loops, user input, conditional statements, arithmetic operations, standard library functions
