// Description: Calculator using a loop and switch-case to perform arithmetic operations until the user exits.
// Concepts used: Loops, switch-case, user input, conditional statements, arithmetic operations
