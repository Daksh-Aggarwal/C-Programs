// Description: Multiplies two user-input matrices and prints the product matrix.
// Concepts used: 2D arrays, nested loops, matrix multiplication, user input, conditional statements
