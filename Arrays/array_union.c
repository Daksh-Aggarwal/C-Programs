// Description: Finds and prints the union of two user-input integer arrays (all unique elements).
// Concepts used: Arrays, loops, user input, conditional statements
