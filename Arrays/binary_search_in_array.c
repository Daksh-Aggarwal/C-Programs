// Description: Performs binary search on a sorted user-input integer array to find a specific element.
// Concepts used: Arrays, loops, sorting, binary search algorithm, user input
