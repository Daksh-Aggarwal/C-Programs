// Description: Calculates and prints the mean, median, and mode of a user-input integer array.
// Concepts used: Arrays, loops, sorting, mean/median/mode calculation, user input
