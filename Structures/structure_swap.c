// Description: Swaps the contents of two structure arrays using a temporary structure array.
// Concepts used: Structures, arrays, swapping, user input, temporary variables
