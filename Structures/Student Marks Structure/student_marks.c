// Description: Manages student marks for three subjects using structures, including grade and percentage calculation.
// Concepts used: Structures, arrays, user input, functions, conditional statements
