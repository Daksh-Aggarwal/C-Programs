// Description: Displays student marks and grades in a tabular format for a dynamic number of subjects using structures.
// Concepts used: Structures, dynamic memory allocation, arrays, user input, functions, tabular display
