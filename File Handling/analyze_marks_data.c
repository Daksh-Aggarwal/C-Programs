// Description: Reads student roll numbers and marks from a file, calculates statistics (average, standard deviation, max, min), identifies failures and topper.
// Concepts used: File I/O, arrays, statistics, loops, conditional statements, math functions
