// Description: Calculates the roots of a quadratic equation (D >= 0) using the quadratic formula.
// Concepts used: Math.h functions, user input, arithmetic operations, quadratic formula
