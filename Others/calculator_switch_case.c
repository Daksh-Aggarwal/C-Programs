// Description: Simple calculator using switch-case to perform basic arithmetic operations.
// Concepts used: Switch-case, user input, arithmetic operations, conditional statements
