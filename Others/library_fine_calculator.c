// Description: Calculates the library fine based on the number of days a book is returned late.
// Concepts used: Conditional statements, arithmetic operations, user input
